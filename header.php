...
<head>
 ...
 +7 (499) 390-59-47 ">
  ...
  <link rel="stylesheet" href="http://beltrakt.ru/templates/beltrakt/css/isotope.css" />
  <link rel="stylesheet" href="http://beltrakt.ru/templates/beltrakt/css/color_scheme.css" />
  <link href='https://fonts.googleapis.com/css?family=Open+Sans&subset=latin,cyrillic' rel='stylesheet' type='text/css'>
  <link rel="stylesheet" href="/http://beltrakt.ru/templates/beltrakt/css/font-awesome.css" />
  <link rel="stylesheet" href="/http://beltrakt.ru/templates/beltrakt/css/font-awesome-ie7.css" />
        ...
        <div class="container-phone">
          <div class="row">
            <div id="headspan">
              ...
              <strong onmouseover="ga('send','event', 'Number', 'Mouseover', '499_head');console.log('click');"><a href="tel:+74993905947">+7 (499) 390-59-47</a></strong>
              <br>
              <img src="http://beltrakt.ru/upload_images/telephone.png" width="16" alt="Телефон">
              <strong onmouseover="ga('send','event', 'Number', 'Mouseover', '925_head');console.log('over');"><a href="tel:+79055396771">+7 (905) 539-67-71</a></strong>
              <br>
              <img src="http://beltrakt.ru/upload_images/telephone.png" width="16" alt="Телефон">
              ...
              <div id="headspan-email"><img src="http://beltrakt.ru/upload_images/email.png" alt="E-mail">
                <script type="text/javascript">
                  //<![CDATA[
                  function hostcmsEmail(c) {
                    return c.replace(/[a-zA-Z]/g, function(c) {
                      return String.fromCharCode((c <= "Z" ? 90 : 122) >= (c = c.charCodeAt(0) + 13) ? c : c - 26);
                    })
                  }
                  document.write('<a  href="mailto:' + hostcmsEmail('vasb@orygenxg.eh') + '">' + hostcmsEmail('vasb@orygenxg.eh') + '</a>'); //]]>
                </script>
              </div>
              <!--				<div id="headspan-time">Пн-Пт с 9:00 до 21:00</div>  -->
              <br>
            </div>
          </div>
        </div>
                  ...
                  <ul class="nav nav-pills">
                    <li class="active dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="/traktory/universalnie-traktory/">Универсальные трактора</a></li>
                        <li><a href="/traktory/energonasyshennie-traktory/">Энергонасыщенные трактора</a></li>
                        <li><a href="/traktory/gusenichnye-traktory/">Гусеничные тракторы</a></li>
                        <li><a href="/traktory/sadovie-traktory/">Садовые тракторы</a></li>
                        <li><a href="/traktory/lesnie-traktory/">Лесные тракторы</a></li>
                        <li><a href="/traktory/snegouborochnye/">Снегоуборочные машины</a></li>
                      </ul>
                    </li>
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="/traktory/navesnoe-oborudovanie/otvaly/">Отвалы</a></li>
                        <li><a href="/traktory/navesnoe-oborudovanie/snegouborochnoe-oborudovanie/">Снегоочистители</a></li>
                        <li><a href="/traktory/navesnoe-oborudovanie/specialnoe-navesnoe-oborudovanie/">Специальное навесное</a></li>
                        <li><a href="/traktory/navesnoe-oborudovanie/kovshi/">Ковши</a></li>
                        <li><a href="/traktory/navesnoe-oborudovanie/rabochie-organy/">Рабочие органы к погрузчику</a></li>
                        <li><a href="/traktory/navesnoe-oborudovanie/trelevochnie-lebedki/">Трелевочные лебедки</a></li>
                        <li><a href="/traktory/navesnoe-oborudovanie/dlya-mtz-320/">— для МТЗ 320</a></li>
                        <li><a href="/traktory/navesnoe-oborudovanie/dlya-mini-pogruz/">— для мини-погрузчиков</a></li>
                      </ul>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href